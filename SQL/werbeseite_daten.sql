...
INSERT INTO `allergen` (`code`, `name`, `type`) VALUES
...
INSERT INTO `gericht` (`id`, `name`, `beschreibung`, `erfasst`, `vegan`, `vegetarisch`, `preis_intern`, `preis_extern`) VALUES
...
alter table bewertungen add column id int(20) not null auto_increment primary key ;
